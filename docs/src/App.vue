<template>
  <div class="min-h-screen bg-cream text-ink dark:bg-dark dark:text-gray-200">
    ...
    <!-- 顶部吸顶导航 -->
    <header class="sticky top-0 z-50 border-b border-black/10 dark:border-white/10 bg-cream md:backdrop-blur-md md:bg-cream/80 dark:bg-dark md:dark:bg-dark/80">
...
const mainTabs = computed(() => {
  const tabs = [
    ...
    { id: 'film-tv', name: '影视动态', count: allItems.value.filter(i => i.category === 'film-tv').length },
